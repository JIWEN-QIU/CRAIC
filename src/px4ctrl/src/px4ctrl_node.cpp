...
int main(int argc, char *argv[])
{
    ...
    ros::Subscriber battery_sub =
        nh.subscribe<sensor_msgs::BatteryState>("/mavros/battery",
                                                10,
                                                boost::bind(&Battery_Data_t::feed, &fsm.battery_data, _1, boost::cref(param)));

    fsm.ctrl_pva_pub = nh.advertise<mavros_msgs::PositionTarget>("/mavros/setpoint_raw/local", 10);
