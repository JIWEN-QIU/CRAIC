...
namespace path_mission {
    ...
    public:
        ...
        double switch_dis, planning_horizon, goal_pub_hz;
        double odom_timeout;
        double publish_dt;
        double discret_resolution;
        ...
        MissionConfig(const ros::NodeHandle &nh_priv) {
            ...
            LoadParam("mission_planner/cmd_type", cmd_type, 1);
            LoadParam("mission_planner/discret_resolution", discret_resolution, 0.3);
            LoadParam("mission_planner/planning_horizon", planning_horizon, 20.0);
            LoadParam("mission_planner/goal_pub_hz", goal_pub_hz, 3.0);
            ...
            for (int i = 0; i < waypoints.size(); i++) {
                cout << BLUE << "\t Waypoint " << i << ": " << waypoints[i].transpose() << RESET << endl;
            }
